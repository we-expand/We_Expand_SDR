      ...
      messages: [
        {
          role: 'system',
          content:
            'Você extrai dados estruturados de texto colado de páginas do LinkedIn (pode ser um único perfil ou uma lista de resultados de busca com várias pessoas). Para cada pessoa identificada, extraia: nome completo, cargo atual, empresa atual, cidade (se houver), país (se houver), e-mail (se houver, geralmente do painel "Informações de contato") e telefone (se houver). Ignore conexões em comum, anúncios, menus e qualquer texto que não seja informação de uma pessoa. Se não conseguir identificar nenhuma pessoa, retorne uma lista vazia. Responda SOMENTE em JSON no formato: {"leads": [{"name": string, "title": string ou null, "company": string ou null, "city": string ou null, "country": string ou null, "email": string ou null, "phone": string ou null}]}.',
        },
